...
plot(Ro-grid_r,sig_r_analytic,'DisplayName','analytic');
hold on
plot(Ro-grid_r,sigma_r,'--','DisplayName','numerical');
legend()
xlabel('Depth (km)');
ylabel('Radial Stress (Pa)')
subplot(1,2,2)
plot((Ro-grid_r)/1e3,sig_t_analytic,'DisplayName','analytic');
hold on
plot((Ro-grid_r)/1e3,sigma_t,'--','DisplayName','numerical');
legend()
xlabel('Depth (km)');
